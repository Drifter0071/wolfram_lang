    ...
    pub fn new() -> Self {
        ...
        // Instance (base class)
        {
            ...
            methods.insert(
                "FindFirstChild",
                MethodInfo {
                    params: vec![("name", "string"), ("recursive", "boolean")],
                    return_type: "Instance?",
                    tags: vec![],
                },
            );
            ...
            methods.insert(
                "WaitForChild",
                MethodInfo {
                    params: vec![("name", "string"), ("timeout", "number")],
                    return_type: "Instance",
                    tags: vec![],
                },
            );
        ...
        // BasePart > Instance
        {
            ...
            methods.insert(
                "Touched",
                MethodInfo {
                    params: vec![("otherPart", "BasePart")],
                    return_type: "RBXScriptSignal",
                    tags: vec!["event"],
                },
            );
            methods.insert(
        ...
        // Humanoid > Instance
        {
            ...
            methods.insert(
                "MoveTo",
                MethodInfo {
                    params: vec![("location", "Vector3"), ("part", "BasePart")],
                    return_type: "nil",
                    tags: vec![],
                },
            );
        ...
        // RemoteEvent > Instance
        {
            ...
            methods.insert(
                ...
                MethodInfo {
                    params: vec![("args", "...")],
                    return_type: "nil",
                    tags: vec!["server-only"],
                },
            );
            methods.insert(
                "FireClient",
                MethodInfo {
                    params: vec![("player", "Player"), ("args", "...")],
                    return_type: "nil",
                    tags: vec![],
                },
            );
        ...
        // Animator > Instance
        {
            ...
            methods.insert(
                "LoadAnimation",
                MethodInfo {
                    params: vec![("animation", "Animation")],
                    return_type: "AnimationTrack",
                    tags: vec![],
                },
            );
            methods.insert(
                ...
                MethodInfo {
                    params: vec![],
                    return_type: "Array<AnimationTrack>",
                    tags: vec![],
                },
            );
            classes.insert(
        ...
        // Data types (no super_class since they're not Instances)
        {
            ...
            methods.insert(
                "new",
                MethodInfo {
                    params: vec![("x", "number"), ("y", "number"), ("z", "number")],
                    return_type: "Vector3",
                    tags: vec![],
                },
            );
            ...
            methods.insert(
                "Lerp",
                MethodInfo {
                    params: vec![("goal", "Vector3"), ("alpha", "number")],
                    return_type: "Vector3",
                    tags: vec![],
                },
            );
        ...
        }
        {
            ...
            methods.insert(
                "Lerp",
                MethodInfo {
                    params: vec![("goal", "Vector2"), ("alpha", "number")],
                    return_type: "Vector2",
                    tags: vec![],
                },
            );
        ...
        }
        {
            ...
            methods.insert(
                "Angles",
                MethodInfo {
                    params: vec![("rx", "number"), ("ry", "number"), ("rz", "number")],
                    return_type: "CFrame",
                    tags: vec![],
                },
            );
            methods.insert(
                "lookAt",
                MethodInfo {
                    params: vec![("at", "Vector3"), ("pos", "Vector3")],
                    return_type: "CFrame",
                    tags: vec![],
                },
            );
            methods.insert(
                "Lerp",
                MethodInfo {
                    params: vec![("goal", "CFrame"), ("alpha", "number")],
                    return_type: "CFrame",
                    tags: vec![],
                },
            );
        ...
        }
        {
            ...
            methods.insert(
                "new",
                MethodInfo {
                    params: vec![("scale", "number"), ("offset", "number")],
                    return_type: "UDim",
                    tags: vec![],
                },
            );
        ...
        }
        {
            ...
            methods.insert(
                "new",
                MethodInfo {
                    params: vec![("r", "number"), ("g", "number"), ("b", "number")],
                    return_type: "Color3",
                    tags: vec![],
                },
            );
            ...
            methods.insert(
                "fromHSV",
                MethodInfo {
                    params: vec![("h", "number"), ("s", "number"), ("v", "number")],
                    return_type: "Color3",
                    tags: vec![],
                },
            );
            methods.insert(
                "Lerp",
                MethodInfo {
                    params: vec![("goal", "Color3"), ("alpha", "number")],
                    return_type: "Color3",
                    tags: vec![],
                },
            );
